App.module("RequestApp.Support", function (Support, App, Backbone, Marionette, $, _) {
    Support.Controller = App.RequestApp.RequestControllerBase.extend({
        initialize: function (options) {
            ...
            this.layoutView = new Support.LayoutView(this);
            ...
            this.show(this.layoutView, {
                loading: {
                    ...
                    errorHandler: _.bind(function (region, resp) {
                        ...
                        this.getErrorHandler(this.glob('request/support/title'), 'request/support/loadingErrors');
                    }, this)
                }
            });
        },
        ...
        onShow: function () {
            var msgType = this.getLicenseMsg(this.initiate.get('LicenseTypes'));
            if (msgType != 0) {
                var msg = this.glob('request/support/license/' + msgType);
                App.lecenseErr.show(new Support.LicenseMessage({ message: msg }));
            }
        ...
        onRequestSend: function () {
            ...
            this.model.save(null, {
                success: _.bind(function (model, resp) {
                    ...
                    this.layoutView.showSuccess('request/support/success', resp);
        ...
        getLicenseMsg: function (types) {
            var nB2B = types['NotActB2B'],
                nB2C = types['NotActB2C'],
                vB2B = types['ValidB2B'],
                vB2C = types['ValidB2C'];

            if (   !vB2B && !vB2C && !nB2B && !nB2C
                || !vB2B && vB2C && !nB2B && nB2C
                || !vB2B && vB2C && !nB2B && !nB2C
                || !vB2B && !vB2C && !nB2B && nB2C)
                return 1;

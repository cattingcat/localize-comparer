App.module("Entities", function (Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.SettingsModel = Entities.Model.extend({
        ...
        changeLang: function (newLang, options) {
            options = options || {};
            var langObj = this.findLang(newLang);
            this.set({ 'language': langObj }, { silent: !!options && !!options.noRequest });
            this.saveLang();
        },
    ...
    var API = {
        getLocalLanguage: function () {
            ...
            if (sessionLang) {
                ...
                //TODO: CA-2113 удалить после бэтты
                if (sessionLangObj.value === 'pl') {
